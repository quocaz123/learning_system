...
import { lessons, exerciseTypes, courses } from '../../data/teacher/exercise';
import { toast } from 'react-toastify';
import { createAssignmentAPI } from '../../../services/AssignmentService';
...
const AssignmentCreate = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            toast.error(`Tạo bài tập thất bại: ${errorMessage}`);
        }
    ...
    const showQuiz = formData.type === 'quiz' || formData.type === 'mixed';
     ...
     // Lọc bài học theo course_id đã chọn
    const filteredLessons = lessons.filter(
        lesson => lesson.course_id === formData.course_id
    );
                    ...
                    <select
                        ...
                        onChange={e => {
                            setFormData(prev => ({
                                ...
                                lesson_id: '' // reset lesson khi đổi course
                            }));
                        }}
